...
function check(event) {
  ...
  if (event.target.checked) {
      ...
      document.getElementById('menu-background').style.left = "-1000px"
    }
}
...
function painttodo(date,classification, text){
    ...
    if( text === '사이다' && classification === 'etc'){
    ...
    if( text === '사과' && classification === '과일'){
        imgText.setAttribute('id','tkrhk');
        imgText.setAttribute('src','./img/apple.svg');
        imgText.style.width = '100px';
        imgText.style.height = '100px';
        imgText.style.padding = '25px';
        }
    if( text === '복숭아' && classification === '과일'){
    ...
    if( text === '메론' && classification === '과일'){
        imgText.setAttribute('id','apfhs');
        imgText.setAttribute('src','./img/melon.svg');
        imgText.style.width = '100px';
        imgText.style.height = '100px';
        imgText.style.padding = '25px';
        }
    if( text === '소고기' && classification === '고기'){
    ...
    if( text === '오리고기' && classification === '고기'){
    ...
    if( text === '돼지고기' && classification === '고기'){
